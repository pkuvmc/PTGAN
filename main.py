...
parser.add_argument('--mask_dir', dest='mask_dir', default='mask_personReid', help='path of the dataset')
...
parser.add_argument('--L2_lambda', dest='L2_lambda', type=float, default=10.0, help='weight on L2 term in objective')
